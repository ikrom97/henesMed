...
@section('content')
   <main class="medservice-page">
      <setion class="medservice">
         <div class="container">
            <h1 class="heading txt-center">{{__('messages.medservices')}}</h1>
            <p class="medservice__text txt-center">{{__('messages.medservicesText')}}</p>
            <ul class="services">
      ...
      <section class="desease">
         <div class="container">
            <h2 class="title txt-center">{{__('messages.deseasesAndTreatment')}}</h2>
            <p class="deseases__text txt-center">{{__('messages.deseasesTreatmentText')}}</p>
